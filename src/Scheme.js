...
function Scheme() {
  return (
    ...
    <h2 style={{marginLeft:"38.5%",paddingTop:"1%",color:"#032154",}}><strong className="yellow"></strong><br/><u>Government Schemes</u></h2>
    <p  style={{marginLeft:"38.5%",paddingBottom:'1%'}}>All Scheme of Gujarat Government</p>
 </div>
